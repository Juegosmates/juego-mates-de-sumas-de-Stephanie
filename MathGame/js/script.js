...
function generateQnA() {
    ...
    // calculate the correct answer by adding the numbers (it could be replace by multipying, sbstracting, dividing)
...
//Generate new Question and Answer for numbers 11 to 20
